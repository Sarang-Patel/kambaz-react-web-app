      ...
      <Table striped>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2022-05-20</td>
            <td className="wd-total-activity">15:12:50</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-total-activity">8:45:30</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2024-02-01</td>
            <td className="wd-total-activity">12:33:44</td>
          </tr>
        </tbody>
      </Table>
    </div>
